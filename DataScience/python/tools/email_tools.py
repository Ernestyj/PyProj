...
class EmailTools():
    ...
    def send_email_with_html_and_imgs(self, host, port, from_addr, to_addr, subject, html_body, img_files, img_cid_names):
    ...
    def send_email_with_text(self, host, port, from_addr, to_addr, subject, text_body):
        MIME_msg_root = MIMEMultipart('related')
        MIME_msg_root['From'] = ','.join(from_addr)
        MIME_msg_root['To'] = ','.join(to_addr)
        MIME_msg_root['Subject'] = subject
